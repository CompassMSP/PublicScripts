...
<policyDefinitions xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" revision="1.0" schemaVersion="1.0" xmlns="http://schemas.microsoft.com/GroupPolicy/2006/07/PolicyDefinitions">
  ...
  <policies>
    ...
    <policy name="EnableODIgnoreFolderListFromGPO" class="Machine" displayName="$(string.EnableODIgnoreFolderListFromGPO)" explainText="$(string.EnableODIgnoreFolderListFromGPO_help)" presentation="$(presentation.EnableODIgnoreFolderListFromGPO_Pres)" key="SOFTWARE\Policies\Microsoft\OneDrive">
        <parentCategory ref="OneDriveNGSC" />
        <supportedOn ref="windows:SUPPORTED_Windows7" />
        <elements>
            <list id="EnableODIgnoreFolderListFromGPOListBox" key="Software\Policies\Microsoft\OneDrive\EnableODIgnoreFolderListFromGPO" additive="true"/>
        </elements>
    </policy>
    ...
    <policy name="AddedFolderHardDeleteOnUnmount" class="Machine" displayName="$(string.AddedFolderHardDeleteOnUnmount)" explainText="$(string.AddedFolderHardDeleteOnUnmount)" key="SOFTWARE\Policies\Microsoft\OneDrive" valueName="AddedFolderHardDeleteOnUnmount">
      <parentCategory ref="OneDriveNGSC" />
      <supportedOn ref="windows:SUPPORTED_Windows_10_0_TH1" />
      <enabledValue>
        <decimal value="1" />
    ...
    <policy name="AddedFolderUnmountOnPermissionsLoss" class="Machine" displayName="$(string.AddedFolderUnmountOnPermissionsLoss)" explainText="$(string.AddedFolderUnmountOnPermissionsLoss)" key="SOFTWARE\Policies\Microsoft\OneDrive" valueName="AddedFolderUnmountOnPermissionsLoss">
      <parentCategory ref="OneDriveNGSC" />
      <supportedOn ref="windows:SUPPORTED_Windows_10_0_TH1" />
      <enabledValue>
        <decimal value="1" />
