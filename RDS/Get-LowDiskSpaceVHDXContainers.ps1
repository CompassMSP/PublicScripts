...
$SMTPServerAddress = 'wdigitech-com.mail.protection.outlook.com'
$TOAddress = 'AMorales@wdigitech.com'
$FROMAddress = 'PowerShellNotifications@wdigitech.com'
...
$ExcludedPaths = @(
    '\\EXAMPLE\ProfileDisks\Data\UVHD-S-1-5-21-1256-309485160-2151-88454.vhdx'
)
